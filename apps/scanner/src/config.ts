...
const envSchema = z.object({
  ...
  LIVE_RPC_URL_ARBITRUM: z.string().url().default('https://arb1.arbitrum.io/rpc'),
  LIVE_RPC_URL_OPTIMISM: z.string().url().default('https://mainnet.optimism.io'),
  LIVE_RPC_URL_POLYGON: z.string().url().default('https://polygon-bor-rpc.publicnode.com'),
  LIVE_RPC_URL_BNB: z.string().url().default('https://bsc-rpc.publicnode.com'),
  LIVE_RPC_URL_AVALANCHE: z.string().url().default('https://api.avax.network/ext/bc/C/rpc'),
  LIVE_RPC_URL_LINEA: z.string().url().default('https://rpc.linea.build'),
