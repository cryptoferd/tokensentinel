...
- Opens three no-API X investigations per result: exact contract mentions, project discussion and warning/scam searches, with individual fallback links when a browser blocks multiple tabs.
